...
public class BlogPublishingService : IBlogPublishingService
{
    ...
    public BlogPublishingService(IConfiguration configuration, Kernel kernel, ILogger<BlogPublishingService> logger)
    {
        ...
        MCPConfig.GitHubRepo = _configuration["GitHub:Repo"]!;
    }
